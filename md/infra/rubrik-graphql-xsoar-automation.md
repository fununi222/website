...
そんな高度な運用を求めるセキュリティ担当者に向けて、最新のAPI規格「[GraphQL](https://fununi222.github.io/websi../../article.html?md=glossary/system-glossary.md#:~:text="GraphQL")」と、運用自動化プラットフォーム「[SOAR](https://fununi222.github.io/websi../../article.html?md=glossary/system-glossary.md#:~:text="SOAR")」を活用した完全自動化の手法を解説します。
...
しかし、[Rubrik](https://fununi222.github.io/websi../../article.html?md=glossary/system-glossary.md#:~:text="Rubrik")はより高度で高速な「GraphQL」という規格へと進化を遂げています。
...
企業レベルの運用では、Cortex [XSOAR](https://fununi222.github.io/websi../../article.html?md=glossary/system-glossary.md#:~:text="XSOAR")（Palo Alto Networks）などのSOAR（セキュリティ・オーケストレーション・自動化・対応）ツールとの連携が最適解です。
...
大規模な医療機関の[SOC](https://fununi222.github.io/websi../../article.html?md=glossary/system-glossary.md#:~:text="SOC")チームでは、RubrikとCortex XSOARを連携させています。
