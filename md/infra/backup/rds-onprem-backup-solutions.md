...
<figure class="mb-12 cyber-glow">
  <img src="../../../../assets/img/infra/backup/rds-onprem-backup-solutions.png" alt="RDS to On-Premises Backup Architecture" class="w-full rounded-2xl shadow-xl border border-white/10 object-cover hover:border-primary/50 transition-colors duration-300">
</figure>
