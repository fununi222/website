...
<img src="https://placehold.co/800x450?text=rag-incremental-indexing" alt="Data Gardening Architecture" class="w-full rounded-2xl shadow-xl border border-white/10 object-cover hover:border-primary/50 transition-colors duration-300">
</figure>
